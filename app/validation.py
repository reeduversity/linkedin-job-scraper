...
def validate_job(job: LinkedInJob | Job | dict[str, Any]) -> LinkedInJob:
    ...
    return LinkedInJob(
        ...
        poster_designation=_normalize_text(data.get("poster_designation")),
        poster_role_category=_normalize_text(data.get("poster_role_category")),
        hiring_confidence_score=data.get("hiring_confidence_score"),
        detection_method=_normalize_text(data.get("detection_method")),
        extraction_method=_normalize_text(data.get("extraction_method")),
        extraction_quality=_normalize_text(data.get("extraction_quality")),
        image_url=_normalize_text(data.get("image_url")),
        image_urls=data.get("image_urls"),
        ocr_text=_normalize_text(data.get("ocr_text")),
        ocr_confidence=data.get("ocr_confidence"),
        ocr_processed=data.get("ocr_processed"),
        ocr_extraction_status=_normalize_text(data.get("ocr_extraction_status")),
        ...
        application_emails=data.get("application_emails"),
        application_platform=_normalize_text(data.get("application_platform")),
        application_urls=data.get("application_urls"),
        application_form_url=_normalize_text(data.get("application_form_url")),
        application_url_type=_normalize_text(data.get("application_url_type")),
